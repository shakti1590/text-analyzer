...
export default function About() {
  ...
  return (
    <div className="container" style={{ color }}>
      ...
      <p>
        <b>Text Analyzer</b> is a ReactJs website built primarily to do various
        operations on regular typed text. You can safely use WordPad or NotePad
        for text drafting, and saving, but <i>Text Analyzer</i> offers much more
        than simple text drafting and formatting. Text can convert your in just one simple click of a button.
        It can extract links and numbers safely from a labyrinth of random text or
        ...
        reading time as well. The best part of <i>Text Analyzer</i> is that it is an
